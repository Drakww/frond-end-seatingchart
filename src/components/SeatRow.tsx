...
const categoryColors: Record<string, string> = {
  ...
  "Complimentary": "#ff8400ff",
  "Potential Brands": "#ff00eaff",
  "Project Lab Guest":"#0a5300ff",
  "Guests per Brand": "#ff8400ff",
  "Selected Models": "#ff8400ff",
  "Giveaway": "#ff8400ff",
  "Performers Guests": "#ff8400ff",
  "Collabs": "#ff8400ff"
};
...
export const SeatRow: React.FC<SeatRowProps> = ({
  ...
  return (
    <div
      className={`flex flex-col items-center w-auto md:w-12  ${filaHeights[fila]} bg-gray-800 rounded-md shadow-md overflow-hidden`}
    >
